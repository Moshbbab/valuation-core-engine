...
class FairValueHierarchyClassifier:
    ...
    def __init__(self, level_2_threshold_months: int = 12, active_market_threshold: int = 10):
        """
    ...
    def classify(
        self, data_sources: List[Dict], assumptions: List[Dict], market_activity: Dict
    ...
    def _classify_data_source(self, source: Dict, market_activity: Dict) -> int:
        """
    ...
    def _classify_assumption(self, assumption: Dict) -> int:
        ...
        market_derived_types = ["discount_rate", "cap_rate", "market_rent"]
    ...
    def generate_disclosure(self, result: ClassificationResult, approach_values: Dict[str, float]) -> Dict:
        """
